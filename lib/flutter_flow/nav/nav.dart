...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => DiscoverWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => DiscoverWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: NowPlayingWidget.routeName,
          path: NowPlayingWidget.routePath,
        ...
        FFRoute(
          name: ShowDetailsWidget.routeName,
          path: ShowDetailsWidget.routePath,
          builder: (context, params) => ShowDetailsWidget(),
        ),
        FFRoute(
